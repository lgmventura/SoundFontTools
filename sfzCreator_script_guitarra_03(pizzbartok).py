...
fp = '/media/luiz/Volume/Downloads/SoundFonts/OrchideaSOL2020_release/OrchideaSOL2020/PluckedStrings/Guitar/pizzicato_bartok'

sfz1 = sfz_creator([], '/media/luiz/Volume/Downloads/SoundFonts/OSOL Guitar pizzicato bartok.sfz')
v1 = 127
# v2 = 99
# v3 = 127
...
sfz1.getSamplesFromFolder(fp, pitch = '-([A-G]#?\d)-', vel='-(ff)-')
