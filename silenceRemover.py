...
folderPath = r"/media/luiz/Volume/Dokumente/Musik/Projekte/SoundFonts/University of Iowa/Crotales"
...
for samFile in samFiles:
    ...
    audioProcessed = removeLeadingSilence(path.join(folderPath, samFile), offset=-5)
