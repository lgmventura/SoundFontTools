...
fp = '/media/luiz/Volume/Downloads/SoundFonts/OrchideaSOL2020_release/OrchideaSOL2020/Brass/Trombone+sordina_cup/ordinario'

sfz1 = sfz_creator([], '/media/luiz/Volume/Downloads/SoundFonts/OSOL Trombone Cup Mute.sfz')
v1 = 40
v2 = 70
v3 = 90
v4 = 108
...
sfz1.getSamplesFromFolder(fp, pitch = '-ord-(\w.?\d)')#, vel='_(v\d)_')
...
sfz1.setForAll('Cutoff', 6000)
sfz1.setForAll('volume', 6)
